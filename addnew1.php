...
<form action="processmem.php" method="post" align="center">
<h1 align="center"> ข้อมูลผู้ประกอบการ </h1>
<input type="text" name="member_id" placeholder="รหัสบัตรประชาชน"><br>
<input type="text" name="First_name" placeholder="ชื่อ (ไม่ต้องมีคำนำหน้า)"><br>
<input type="text" name="Last_name" placeholder="นามสกุล"><br>
<input type="text" name="AddressOwn" placeholder="ที่อยู่ผู้ประกอบการ"><br>
